...
void UIManager::make_StartScreen() {
    ...
    startScreenUI->setTexture(BaseUI::loadTexture("../resources/BarnyardBreakout.png"));
    startScreenUI->setShader(make_unique<Shader>("../resources/shaders/baseUi.vert", "../resources/shaders/baseUi.frag"));
}
