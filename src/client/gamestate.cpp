...
GameState::GameState() {
  ...
  InitializeGameObject("../src/client/shaders/shader.vert", "../src/client/shaders/shader.frag", "../src/client/resources/objects/cow/Cow.obj", 
    glm::vec3(0, -0.1, 0), glm::vec3(0), glm::vec3(1), glm::vec3(10, 0.1, 10));	
  ...
  InitializeGameObject("../src/client/shaders/shader.vert", "../src/client/shaders/shader.frag", "../src/client/resources/objects/pig/Pig.obj", 
    glm::vec3(0, 0, 2), glm::vec3(0), glm::vec3(1), glm::vec3(0.625, 0.5, 0.218));
	InitializeGameObject("../src/client/shaders/shader.vert", "../src/client/shaders/shader.frag", "../src/client/resources/objects/sheep/Sheep.obj", 
		glm::vec3(2, 0, 0), glm::vec3(0), glm::vec3(1), glm::vec3(0.86, 0.625, 0.565));
  InitializeGameObject("../src/client/shaders/shader.vert", "../src/client/shaders/shader.frag", "../src/client/resources/objects/cow/Cow.obj", 
    glm::vec3(-2, 0, 0), glm::vec3(0), glm::vec3(1), glm::vec3(0.955, 0.75, 0.38));	
...
GameObject *GameState::InitializeGameObject(const char *vertexPath,
  ...
  GameObject *object =
      new GameObject(gameObjects.size(), true, transform_ptr, rigidbody_ptr, collider_ptr);
...
void GameState::KeyboardInput(float deltaTime) {
  ...
  float maxJumpTime = 0.5f;
    ...
    player->setGrounded(false);
	  player->getRigidBody()->applyImpulse(jumpForce * glm::vec3(0,1,0) * deltaTime);
    jumpTime += deltaTime;
  }
