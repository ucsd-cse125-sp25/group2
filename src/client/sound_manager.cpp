...
void SoundManager::preLoadSounds() {
  // bgm
  loadSound("CharacterSelectBGM",
            "../resources/audio/Character_Selection_Screen.mp3", true);
  ...
  loadSound("BoxDraggingSound", "../resources/audio/BoxDraggingSound.ogg",
            false);
  loadSound("Barnyard_Secret_Sound",
            "../resources/audio/Barnyard_Secret_Sound.ogg", false);
  loadSound("JumpLandingSound", "../resources/audio/JumpLandingSound.ogg",
            false);
